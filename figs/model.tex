\begin{tikzpicture}
  ...
  \draw[-latex] (do.east) -- (sp.west) node [midway,above,font=\scriptsize] {Data {\onslide*<3->{\& \alert{ADS}}}};
  \draw[-latex,transform canvas={yshift=0.5ex}] (client.west) -- (sp.east) node [midway,above,font=\scriptsize] {Queries};
  \draw[-latex,transform canvas={yshift=-0.5ex}] (sp.east) -- (client.west) node [midway,below,font=\scriptsize] {Results {\onslide*<3->{\& \alert{VO}}}};
